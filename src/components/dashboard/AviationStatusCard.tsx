...
export default function AviationStatusCard() {
  return (
    <div className="group bg-slate-900/60 border border-slate-800 rounded-sm p-2 hover:border-slate-700 transition-all duration-300 relative overflow-hidden h-full flex flex-col max-h-[250px] overflow-y-auto custom-scrollbar">
      {/* Tactical Glow */}
      ...
      <div className="flex items-center justify-between mb-2 pb-1.5 border-b border-slate-800/50">
        <div className="flex items-center gap-2">
            <Plane className="w-3.5 h-3.5 text-blue-400 group-hover:rotate-12 transition-transform duration-500" />
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-200 font-sans">
                Aviation & Logistics
            </h3>
        </div>
        <div className="flex items-center gap-1.5">
            <span className="w-1 h-1 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.4)] animate-pulse" />
            <span className="text-[8px] font-sans font-bold text-green-500 tracking-widest uppercase">Live</span>
        </div>
      </div>
